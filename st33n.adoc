...
My latest work for Jayway includes building fairly complex Javascript-based front-ends with mainly Ruby on Rails back-ends, using Vim.
...
* Sony Ericsson (Xperia Lounge Voucher Server)
* TrueSec
* Cloudfinder
* 3 (3Switch)
...
graphicsfootnoteref:[cpndemo,https://www.youtube.com/watch?v=riLWVf_3BOQ].
